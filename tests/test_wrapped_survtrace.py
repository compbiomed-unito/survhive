...
trace_test.exp_score = 0.93
trace_test.exp_cv_mean = 0.64
trace_test.exp_cv_std = 0.03
trace_test.exp_survival = [[0.85, 0.78, 0.64]]
# trace_test.exp_survival = [[0.95, 0.94, 0.87]]
trace_test.exp_td_harrel_score = 0.91
trace_test.exp_td_brier_score = -0.05
trace_test.exp_td_roc_auc_score = 0.96
